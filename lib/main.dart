...
// import 'package:mstoo/user/main.dart' as userapp;
// import 'package:mstoo/renter/main.dart' as renterapp;
...
//                 prefs.remove('demand_token');

//                 renterapp.main();
//               },
//               child: const Text("Continue as Renter"),
//             ),
//           ],
//         ),
//       ),
...
// Run user app on start
import 'package:mstoo/user/data/model/notification_body.dart';
import 'package:mstoo/user/feature/home/widget/cookies_view.dart';
import 'package:flutter_downloader/flutter_downloader.dart';
import 'package:flutter_local_notifications/flutter_local_notifications.dart';
import 'package:get/get.dart';
import 'package:mstoo/user/core/core_export.dart';
import 'package:mstoo/user/core/helper/language_di.dart' as di;
import 'package:mstoo/user/core/helper/notification_helper.dart';
...
Future<void> main() async {
  ...
  runApp(UserApp(languages: languages, body: body));
}

class UserApp extends StatelessWidget {
  final Map<String, Map<String, String>>? languages;
  final NotificationBody? body;
  const UserApp({super.key, @required this.languages, @required this.body});
  void _route() async {
