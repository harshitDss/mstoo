...
class CustomRenterButton extends StatelessWidget {
  ...
  final Color? color;
  final String btnTxt;
  CustomRenterButton({this.onPressed, this.transparent = false, this.margin, this.width, this.height,this.color,
  ...
  Widget build(BuildContext context) {
    ...
    return Center(child: SizedBox(width: width != null ? width : Dimensions.webMaxWidth, child: Padding(
