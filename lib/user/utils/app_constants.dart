import 'package:mstoo/user/data/model/choose_us_model.dart';
import 'package:mstoo/user/data/model/response/language_model.dart';
import 'package:mstoo/user/utils/images.dart';

class AppConstants {
  static const String appName = 'MSTOO App';
  static const String appVersion = '1.0';

  static const String baseUrl = 'https://mstooapp.design-street.com.au';
  ...
  static const String bookingRequest = '/api/v1/customer/booking/request/get';
  static const String bookingRequestShow = '/api/v1/customer/booking/request/show';
  static const String bookingAcceptStatusUrl = '/api/v1/provider/booking/request-accept';
  static const String bookingRejectStatusUrl = '/api/v1/provider/booking/request-reject';
  ...
  // custom api route by naresh
  static const String changeScheduleUrl = '/api/v1/customer/booking/schedule-update';
  static const String markCompleted = '/api/v1/customer/booking/mark-completed';
  static const String markCompletedByRenter = '/api/v1/customer/booking/mark_completed_by_renter';
  static const String sortByPriceAsec = '/api/v1/customer/service/sort_by_price_asec/';
  static const String sortByPriceDesc = '/api/v1/customer/service/sort_by_price_desc/';
  static const String sortByNewest = '/api/v1/customer/service/sort_by_newest/';
  static const String sortByOldest = '/api/v1/customer/service/sort_by_oldest/';

  static const String sortAllServiceByPriceAsec = '/api/v1/customer/service/sort_allservice_by_price_asec/';
  static const String sortAllServiceByPriceDesc = '/api/v1/customer/service/sort_allservice_by_price_desc/';
  static const String sortAllServiceByNewest = '/api/v1/customer/service/sort_allservice_by_newest/';
  static const String sortAllServiceByOldest = '/api/v1/customer/service/sort_allservice_by_oldest/';

  static const String likedServices = '/api/v1/customer/service/liked_services/';
