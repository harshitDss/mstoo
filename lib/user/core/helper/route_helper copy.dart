import 'dart:convert';
import 'package:mstoo/user/data/model/notification_body.dart';
import 'package:mstoo/user/feature/checkout/view/custom_post_checkout_screen.dart';
import 'package:mstoo/user/feature/create_post/model/my_post_model.dart';
import 'package:mstoo/user/feature/create_post/model/provider_offer_model.dart';
import 'package:mstoo/user/feature/create_post/view/create_post_screen.dart';
import 'package:mstoo/user/feature/create_post/view/post_create_successfully_screen.dart';
import 'package:mstoo/user/feature/my_post/view/provider_offer_details_screen.dart';
import 'package:mstoo/user/feature/my_post/view/provider_offers_list_screen.dart';
import 'package:mstoo/user/feature/loyalty_point/binding/loyalty_point_binding.dart';
import 'package:mstoo/user/feature/loyalty_point/loyality_point_screen.dart';
import 'package:mstoo/user/feature/my_post/view/all_post_screen.dart';
import 'package:mstoo/user/feature/provider/view/all_provider_view.dart';
import 'package:mstoo/user/feature/provider/view/provider_details_screen.dart';
import 'package:mstoo/user/feature/provider/view/provider_review_screen.dart';
import 'package:mstoo/user/feature/provider_webview/become_a_provider.dart';
import 'package:mstoo/user/feature/refer_and_earn/refer_and_earn_screen.dart';
import 'package:mstoo/user/feature/service/model/feathered_service_model.dart';
import 'package:mstoo/user/feature/service/view/all_feathered_category_services.dart';
import 'package:mstoo/user/feature/suggest_new_service/binding/suggest_service_binding.dart';
import 'package:mstoo/user/feature/suggest_new_service/view/suggest_service_screen.dart';
import 'package:mstoo/user/feature/suggest_new_service/view/suggested_service_list_screen.dart';
import 'package:mstoo/user/feature/wallet/binding/wallet_binding.dart';
import 'package:mstoo/user/feature/wallet/wallet_screen.dart';
import 'package:get/get.dart';
import 'package:mstoo/user/core/initial_binding/initial_binding.dart';
import 'package:mstoo/user/feature/category/bindings/category_bindings.dart';
import 'package:mstoo/user/feature/category/view/sub_category_screen.dart';
import 'package:mstoo/user/feature/checkout/view/payment_screen.dart';
import 'package:mstoo/user/feature/service/view/all_service_view.dart';
import 'package:mstoo/user/feature/html/html_viewer_screen.dart';
import 'package:mstoo/user/feature/settings/bindings/settings_bindings.dart';
import 'package:mstoo/user/utils/html_type.dart';
