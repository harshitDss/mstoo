...
import 'package:mstoo/user/feature/checkout/widget/custom_header_icon_section.dart';
import 'package:mstoo/user/feature/checkout/widget/custom_header_line.dart';
import 'package:mstoo/user/feature/checkout/widget/custom_text.dart';
import 'package:mstoo/user/feature/checkout/widget/order_complete_section/complete_page.dart';
import 'package:mstoo/user/feature/checkout/widget/order_details_section/order_details_page.dart';
import 'package:mstoo/user/feature/checkout/widget/order_details_section/order_details_page_web.dart';
import 'package:mstoo/user/feature/checkout/widget/payment_section/payment_page.dart';
                                               ...
                                               if(!Get.find<ScheduleController>().checkScheduleTime()) {
                                                 ...
                                                 if(controller.currentPageState == PageState.orderDetails && PageState.orderDetails.name == widget.pageState){
                                                   ...
                                                   if(Get.find<CartController>().cartList.isNotEmpty){
                                                    ...
                                                    // note
                                                     String note = Get.find<ScheduleController>().noteController.text;
