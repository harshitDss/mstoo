...
class AuthRepo {
  ...
  Future<Response?> login({required String phone, required String password}) async {
     ...
     debugPrint(appSignatureID.toString());
    ...
    return await apiClient.postData(AppConstants.loginUri, {"email_or_phone": phone, "password": password, "device_token": deviceToken,"signature_id": appSignatureID.toString()});
  }
  ...
  Future<Response> sendOtpForVerificationScreen(String identity, String type) async {
    ...
    return await apiClient.postData(AppConstants.sendOtpForVerification, {
      "identity": identity,
      "identity_type": type,
      "signature_id": appSignatureID.toString()
    });
  }
