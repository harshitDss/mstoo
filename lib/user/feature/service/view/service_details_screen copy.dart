...
import 'package:mstoo/user/feature/service/widget/service_details_faq_section.dart';
...
import 'package:mstoo/user/core/helper/decorated_tab_bar.dart';
...
class _ServiceDetailsScreenState extends State<ServiceDetailsScreen> {
  ...
  void getRenter() async {
    var res = await CallApi()
        .getGuestDataById('/api/v1/customer/service/getrenter/', widget.serviceID);
  ...
  void removeSaveForLater() async {
    ...
    var res = await CallApi()
        .postData(token, data, '/api/v1/customer/service/remove_save_for_later');
                ...
                child: DefaultTabController(
                  ...
                  child: Column(
                    children: [
                      ...
                      // custom widget added to show renter info
                      dashboard != null
                          ? Column(
                              children: [
                                const Text(
                                ...
                                Text(
                                  "Available on: ${dashboard['availability']['date'].toString()}",
                                )
