class ServiceRequestBookingList {
  String? responseCode;
  String? message;
  BookingContent? content;

  ServiceRequestBookingList({this.responseCode, this.message, this.content,});

  ServiceRequestBookingList.fromJson(Map<String, dynamic> json) {
...
class BookingContent {
  int? currentPage;
  List<BookingRequestModel>? bookingRequestModel;
  String? firstPageUrl;
  int? from;
  int? lastPage;
  String? lastPageUrl;
  ...
  BookingContent.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        bookingRequestModel!.add(BookingRequestModel.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (bookingRequestModel != null) {
      data['data'] = bookingRequestModel!.map((v) => v.toJson()).toList();
    }
