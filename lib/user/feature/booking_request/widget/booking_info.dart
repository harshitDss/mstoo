          ...
          children: [
            Column(
              ...
              children: [
                ...
                // custom widget by naresh to change schedule
                Row(
                  children: [
                    Expanded(
                              flex: 3,
                              child: CustomButton(
                                height: 40,
                                buttonText: bookingDetailsContent.scheduleHistories!.length<=1? "Reschedule Booking"
                                    : bookingDetailsTabController.bookingDetailsContent!.serviceSchedule!,
                                onPressed: (){
                                  if (bookingDetailsContent.bookingStatus != 'accepted') {
                                    customSnackBar('${'service'.tr} ${bookingDetailsContent.bookingStatus.toString().tr.toLowerCase()} '
                                        "Can not change schedule now");
                                  } else {
                                    bookingDetailsTabController.selectDate();
                                  }
                                },
                              ),
                            ),
