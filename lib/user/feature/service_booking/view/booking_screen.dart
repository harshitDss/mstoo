...
import 'package:mstoo/user/feature/service_booking/widget/booking_item_card.dart';
import 'package:mstoo/user/feature/service_booking/widget/booking_screen_shimmer.dart';
import 'package:mstoo/user/feature/service_booking/widget/booking_status_tabs.dart';
...
class _BookingScreenState extends State<BookingScreen> {
  ...
  void initState() {
    ...
    Get.find<ServiceBookingController>().updateBookingStatusTabs(BookingStatusTabs.all, firstTimeCall: true);
