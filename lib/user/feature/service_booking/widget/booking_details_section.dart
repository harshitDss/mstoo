...
import 'package:mstoo/user/feature/service_booking/widget/booking_summery_widget.dart';
import 'package:mstoo/user/feature/service_booking/widget/provider_info.dart';
import 'package:mstoo/user/feature/service_booking/widget/service_man_info.dart';
import 'booking_screen_shimmer.dart';

class BookingDetailsSection extends StatelessWidget {
  final String bookingID;
  const BookingDetailsSection({Key? key, required this.bookingID})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (bookingDetailsContent.serviceman != null)
                    ServiceManInfo(
                        user: bookingDetailsContent.serviceman!.user!),
                  const SizedBox(height: Dimensions.paddingSizeSmall),
      ...
      floatingActionButton: GetBuilder<BookingDetailsTabsController>(
        ...
        if (bookingDetailsController.bookingDetailsContent != null) {
          return Column(
            ...
            children: [
              ...
              if (bookingDetailsController.bookingDetailsContent!.userStatus ==
                  'completed')
                CustomButton(
                  radius: 0,
              ...
              if (bookingDetailsController.bookingDetailsContent!.bookingStatus ==
                  'pending')  
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  ElevatedButton(onPressed: () {
                    print(bookingDetailsController.bookingDetailsContent!.bookingStatus);
                    bookingDetailsController.acceptBookingRequest(bookingDetailsController.bookingDetailsContent!
                                                            .id!);
                  }, child: const Text("Accept")),
                  ElevatedButton(
                    child: const Text('Reject'),
                    onPressed: () {
                      bookingDetailsController.rejectBookingRequest(bookingDetailsController.bookingDetailsContent!
                                                            .id!);
                    },
              ...
              if (bookingDetailsController.bookingDetailsContent!.userStatus !=
                ...
                CustomButton(
                  ...
                  onPressed: () {
                    bookingDetailsController.markCompletedByRenter();
                  },
                )
            ],
          );
