                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      //   height: ResponsiveHelper.isMobile(context)?60:ResponsiveHelper.isTab(context)?40:60,
                                      //   width: ResponsiveHelper.isMobile(context)?60:ResponsiveHelper.isTab(context)?40:60,

                                      // ),

                                      child: Image.network(
                                        '${Get.find<SplashController>().configModel.content!.imageBaseUrl}/category/${categoryController.categoryList![index].image}', //extensions like .jpg, .png etc
                                        height: 50,
                                        errorBuilder:
                                            (context, error, stackTrace) =>
                                                SvgPicture.network(
                                          '${Get.find<SplashController>().configModel.content!.imageBaseUrl}/category/${categoryController.categoryList![index].image}', // for .svg extension
                                          height: 50,
                                        ),
                                      ),
                                    ),
                                      ...
                                      child: Text(
                                        ...
                                        style: ubuntuRegular.copyWith(
                                            fontSize: MediaQuery.of(context)
                                                ...
                                                : Dimensions.fontSizeExtraSmall),
                                        // style: ubuntuRegular.copyWith(fontSize: MediaQuery.of(context).size.width<300?Dimensions.fontSizeDefault:Dimensions.fontSizeDefault),
                                        maxLines:
